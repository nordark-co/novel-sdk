...
import SlashCommand, { SlashCommandConfig } from "./slash-command";
...
type DefaultExtensionBuilderOptions = {
	defaultPlaceholderText?: string,
	customSlashCommands?: SlashCommandConfig['customItems']
};

export function getDefaultExtensions(options?:DefaultExtensionBuilderOptions) {
	return [
		...
		Placeholder.configure({
			placeholder: ({ node }) => {
				...
				return options?.defaultPlaceholderText ?? "Press '/' for commands, or '++' for AI autocomplete...";
			},
			includeChildren: true,
		}),
		SlashCommand.configure({
			customItems: options?.customSlashCommands
		}),
		TiptapUnderline,
		TextStyle,
		Color,
