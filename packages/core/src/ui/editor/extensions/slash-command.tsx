...
const suggestionItemsBuilder = (customItems?: SlashCommandConfig['customItems']) => {
...
const SlashCommand = {
	configure(config: SlashCommandConfig) {
		return Command.configure({
			suggestion: {
				items: suggestionItemsBuilder(config.customItems),
				render: renderItems,
			},
		});
	}
